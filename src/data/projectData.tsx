...
export const omniProject: ProjectType = {
...
export const argoProject: ProjectType = {
    title: "Argo",
...
export const dayZeroProject: ProjectType = {
...
export const inspectorBaxterProject: ProjectType = {
...
export const techtilesProject: ProjectType = {
    title: "Techtiles",
...
export const motorControllerProject: ProjectType = {
...
export const neuralNetProject: ProjectType = {
...
export const pathPlanProject:ProjectType = {
    title: "Path Planning",
