...
export default function Sidebar(props: {title:string}) {
    ...
    return (
        <div id="sidebar" className={`float-left box-border px-12 pt-40 pb-20 flex flex-col justify-between items-start h-full grow-0 shrink-0 ${slideInClasses} ${navSelect === "home" ? "w-0" : "w-[300px]"}`}>
