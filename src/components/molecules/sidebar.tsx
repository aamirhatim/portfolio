...
export default function Sidebar(props: {title:string}) {
    ...
    return (
        <div id="sidebar" className={`float-left box-border pt-40 pb-20 flex flex-col justify-between items-start h-full grow-0 shrink-0 ${slideInClasses} ${(navToHome || navToArticle) ? "w-0" : "px-12 w-[300px]"}`}>
